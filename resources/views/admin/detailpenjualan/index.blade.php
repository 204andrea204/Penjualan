          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="{{url('/admin/detailpenjualan/save')}}" method="POST" enctype="multipart/form-data">

                  <div class="form-group">
                    <label for="formGroupExampleInput">nofaktur</label>
                     <select class="form-control" name="nofaktur">
                      <?php
                        $nofaktur = \App\tblpenjualan::all();
          ...
          <!-- /.modal-dialog -->
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php
                    $i= 1;
                    $detailpenjualan = \App\tbldetailpenjualan::all();
                    ?>
                  @foreach($detailpenjualan as $q)
                <tr>
                  <th scope="row">{{$i++}}</th>
                  ...
                  <td>
                  	...
                  	<a href="{{url('admin/detailpenjualan/delete/'.$q->id)}}" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin ingin menghapusnya ?');"><i class="fa fa-trash"></i></a>
        ...
        <div class="modal fade" id="modal-edit{{$q->id}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="{{url('/admin/detailpenjualan/update')}}" method="POST" enctype="multipart/form-data">
