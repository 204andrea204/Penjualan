...
@section('content')
         ...
         <form action="{{url('/admin/petugas/update')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            placeholder="idpetugas" value="{{$petugas->idpetugas}}" required>
          </div>
          <div class="form-group">
